...
import 'package:flutter_project_2/others/rxdart.dart/demo.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  BehaviorSubject<List<String>> streamController = BehaviorSubject<List<String>>();
                ...
                Container(
                  ...
                  child: StreamBuilder(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasData) {
                        List<String> data = snapshot.data!.toList() ;
                        return ListView(
                          children: data
                              .map((s) => ListTile(
                                    title: Text(s),
